...
export const WINO_MENU_RESPONSE: AnalyzeResponse = {
  ...
  pairings: [
    ...
    { dish_id: "d1", wine_id: "w1", score: 0.94, reason: "Vermentino's citrus freshness cuts through fried risotto.", detailed_reason: "Detailed pairing text for d1-w1.", label: "best_pick" },
    { dish_id: "d1", wine_id: "w3", score: 0.89, reason: "Etna Rosato bridges the tomato sugo with delicate fruit.", detailed_reason: "Detailed pairing text for d1-w3.", label: "wild_one" },
    ...
    // Branzino (d2) → w1, w5
    { dish_id: "d2", wine_id: "w1", score: 0.96, reason: "Classic Mediterranean white with Mediterranean fish.", detailed_reason: "Detailed pairing text for d2-w1.", label: "best_pick" },
    { dish_id: "d2", wine_id: "w5", score: 0.88, reason: "Soave's gentle acidity lets the branzino shine.", detailed_reason: "Detailed pairing text for d2-w5.", label: "wild_one" },
    // Osso Buco (d3) → w2, w4
    { dish_id: "d3", wine_id: "w2", score: 0.97, reason: "Barolo's power matches braised veal perfectly.", detailed_reason: "Detailed pairing text for d3-w2.", label: "best_pick" },
    { dish_id: "d3", wine_id: "w4", score: 0.93, reason: "Brunello's tannins cut through the rich braise.", detailed_reason: "Detailed pairing text for d3-w4.", label: "wild_one" },
    // Truffle Pasta (d4) → w2, w4
    { dish_id: "d4", wine_id: "w2", score: 0.95, reason: "Nebbiolo's earthy character mirrors truffle.", detailed_reason: "Detailed pairing text for d4-w2.", label: "best_pick" },
    ...
    // Caprese (d5) → w3, w1
    { dish_id: "d5", wine_id: "w3", score: 0.92, reason: "Rosato's freshness pairs with tomato and burrata.", detailed_reason: "Detailed pairing text for d5-w3.", label: "best_pick" },
    { dish_id: "d5", wine_id: "w1", score: 0.87, reason: "Vermentino's herbs echo the basil.", detailed_reason: "Detailed pairing text for d5-w1.", label: "wild_one" },
  ],
  language: "en",
};
...
export const SINGLE_DISH_RESPONSE: AnalyzeResponse = {
  ...
  pairings: [
    { dish_id: "d1", wine_id: "w1", score: 0.94, reason: "Vermentino's citrus freshness cuts through fried risotto.", detailed_reason: "Detailed.", label: "best_pick" },
    { dish_id: "d1", wine_id: "w3", score: 0.89, reason: "Etna Rosato bridges the tomato sugo.", detailed_reason: "Detailed.", label: "wild_one" },
